...
class _CDMOptionButton(customtkinter.CTkButton):
    def setParentMenu(self, menu: "CustomMenu"):
...
class _CDMSubmenuButton(_CDMOptionButton):
    def setSubmenu(self, submenu: "CustomMenu"):
    ...
    def configure(self, **kwargs):
        ...
        super().configure(**kwargs)
class CustomMenu(customtkinter.CTkFrame):
    ...
    def add_submenu(self, submenu_name: str, **kwargs) -> "CustomMenu":
        ...
        submenuButtonSeed.bind("<Enter>", lambda e, sub=submenu, button=submenuButtonSeed: self.after(500,
                                                                                                      lambda: sub._show_submenu(
                                                                                                          self,
                                                                                                          button)),
                               add="+")
    ...
    def _show_submenu(self, parent, button) -> None:
        ...
        if (str(widget) != str(button._canvas)) and (str(widget) != str(button._text_label)) and (
