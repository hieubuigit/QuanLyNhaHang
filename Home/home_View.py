...
class HomeView:
    ...
    def __init__(self, window):
        ...
        ic_empl_click = CTkImage(
            Image.open("../assets/ic_employees_click.png").resize(HomeView.size_icon_tab))
    ...
    def __generate_ui_header(self, window):
        ...
        avt_default = CTkImage(Image.open("../assets/avatar_default_man.png").resize(
            (35, 35)))

        profile_btn = CTkButton(header_view, text="Admin director", image=avt_default, corner_radius=0, bg_color="white", fg_color="black")
        ...
        self.bill_btn = CTkButton(self.tab_bar_view, text="Hóa đơn", corner_radius=0,
